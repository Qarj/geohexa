...
QUnit.test('Test distance between two lat lons', function(assert) {
    assert.near(distance(51.487141, -0.125873, 51.488178, -0.128224), 199.48427672, 'Distance from one side of Vauxhall bridge to the other is about 200 meters');
});
